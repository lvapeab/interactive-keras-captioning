...
def main():
    ...
    splits = [path_files + '/' + train, path_files + '/' + val,
              path_files + '/' + test]
    splits_out = [path_files + '/' + train_out, path_files + '/' + val_out,
                  path_files + '/' + test_out]
    splits_counts = [path_files + '/' + train_out_counts,
                     path_files + '/' + val_out_counts,
